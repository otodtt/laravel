...
@section('content')
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                ...
                @include('records.index_violation.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/протоколи-нарушения/сортирай', 'method'=>'POST')) !!}
                    @include('records.index_violation.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('records.index_violation.alphabet')
    <div class="refresh">
        <a href="{{ url('/протоколи-нарушения') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
    @include('records.index_violation.table')
@endsection
