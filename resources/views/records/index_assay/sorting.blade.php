...
$select_violation = array(''=>'избери', 1 => 'Остатъци от ПРЗ', 2 => 'Идентификация на ПРЗ', 3 => 'Нитрати',
                            4 => 'Тежки метали', 5 => 'Микробио. Замърсители', 6 => 'Друго')
?>
...
['id' => 'assay_input', 'class'=>'form-control form-control-my-search ot_object_sort ']) !!}
