            ...
            <fieldset class="small_field"><legend class="small_legend">Констатация и други данни</legend>
                ...
                <div class="col-md-12 col-md-6_my  ">
                    <div class="col-md-4 col-md-6_my inspectors_divs ">
                        ...
                        {!! Form::textarea('ascertainment', null, ['class'=>'form-control form-control-my', 'cols'=>'50', 'rows'=>'4']) !!}
                    </div>
                    <div class="col-md-4 col-md-6_my inspectors_divs ">
                        {!! Form::label('taken', 'Конфискувани:', ['class'=>'my_labels']) !!}
                        {!! Form::textarea('taken', null, ['class'=>'form-control form-control-my', 'cols'=>'50', 'rows'=>'4']) !!}
                    </div>
                    <div class="col-md-4 col-md-6_my inspectors_divs ">
                        {!! Form::label('order_protocol', 'Предписание:', ['class'=>'my_labels']) !!}
                        {!! Form::textarea('order_protocol', null, ['class'=>'form-control form-control-my', 'cols'=>'50', 'rows'=>'4']) !!}
                    </div>
                </div>
            </fieldset>
        </div>
