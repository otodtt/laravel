...
{!! Form::select('ot_object', $type_opinion , $sort_object_return,
['id' => 'ot_object', 'class'=>'form-control form-control-my-search ot_object_sort ']) !!}

{!! Form::label('assay_sort', ' или', ['class'=>'labels']) !!}
{!! Form::select('assay_sort', $type_check , $sort_assay_return,
['id' => 'assay_sort', 'class'=>'form-control form-control-my-search ot_object_sort ']) !!}
