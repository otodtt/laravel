...
@section('content')
    ...
    <div class="alert alert-danger my_alert" role="alert">
        <p class="my_p"><span class="fa fa-warning red" aria-hidden="true"></span> <span class="bold red">Внимание! Прочети преди да продължиш!</span><br/>
            <span class="bold">
                Провери внимателно данните! Ако има грешки, редактирай данните на Търговеца и тогава добави Формуляр!
            </span>
        </p>
    </div>
    <div class="form-group">
        ...
        <div class="alert alert-info my_alert" role="alert">
            <div class="row">
                <div class="col-md-12 ">
                    <h4 class="my_center bold">ФОРМУЛЯР ЗА СЪОТВЕТСТВИЕ НА НЕРЕГЛАМЕНТИРАН ТЪРГОВЕЦ</h4>
                </div>
            </div>
        </div>
        {!! Form::model($compliance, ['url'=>'контрол/формуляр/нерегламентиран/update/'.$compliance->id , 'method'=>'POST', 'autocomplete'=>'on']) !!}

            @include('quality.compliance.edit.forms.form_unregulated')
            ...
            <div class="col-md-6" id="add_certificate" >
                {!! Form::submit('Реактирай формуляр!', ['class'=>'btn btn-danger', 'id'=>'submit']) !!}
            </div>
