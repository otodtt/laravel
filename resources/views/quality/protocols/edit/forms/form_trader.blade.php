        ...
        <div class="col-md-6" >
            <fieldset class="small_field"><legend class="small_legend">1. Търговец /Trader</legend>
                <div class="col-md-7 col-md-6_my">
                    ...
                    if (old('address') == null) {
                        $address = $protocol->trader_address;
                    } else {
                        $address = old('address');
                    }
                    if (old('vin') == null) {
                        $vin_number = $protocol->trader_vin;
                    } else {
                        $vin_number = old('vin');
                    }
                    ?>
        ...
        <div class="col-md-6" >
            <fieldset class="small_field"><legend class="small_legend">Други данни</legend>
                <div  class="col-md-12">
                    ...
                    {!! Form::text('mobile', $protocol->trader_phone, ['class'=>'form-control', 'style'=>'width: 80%', 'placeholder'=>'0888 000 000']) !!}
                    <br>
                </div>
            </fieldset>
        </div>
