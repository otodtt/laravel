...
@section('content')
    ...
    <div class="info-wrap">
        <a href="{!! URL::to('/контрол/сертификат-внос/'.$certificate[0]['id'])!!}" class="fa fa-user btn btn-success my_btn my_float"> Назад към сертификата!</a>
    </div>
    ...
    @if(isset($alert) && $alert == 1 || Auth::user()->id == 2 || Auth::user()->id == 10)
        <div class="alert-danger" style=" text-align: center; margin: 10px 0; border: 1px solid black; ">
            ...
            <div class="row" style="margin: 10px 0 10px 0">
                <div class="col-md-4" style="text-align: center">
                    <a href="{{ url('/контрол/фактури-внос/'.$certificate[0]['id']) }}" class="fa fa-eraser btn btn-primary my_btn"> ОТКАЖИ</a>
                </div>
                <div class="col-md-8" style="text-align: center">
                    {!! Form::open(['url'=>url('контрол/фактури-внос/обнови/'.$certificate[0]['id']) , 'method'=>'POST']) !!}
                    ...
                    <div class="col-md-4 col-md-6_my" >
                        ...
                        {!! Form::submit('РЕДАКТИРАЙ', ['class'=>'btn btn-danger', 'id'=>'submit_yes']) !!}
