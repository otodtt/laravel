<?php
    ...
    for ($i = 0 ;  $i <$ic ; ++$i) {
        ...
        foreach ($alphabet as $v){
            if($v === $i){
                if($abc_sel == $i){
                    echo '<a href="/фирми/сортирай/'.$i.'/'.$sorting.'" class="alfabet, ,alfmark" name="abc" >[ '.$alphabet_bg[$i].' ]</a>&nbsp;&nbsp;';
                    $keys = $i;
                    break;
                }
                else{
                    echo '<a href="/фирми/сортирай/'.$i.'/'.$sorting.' " class="alfabet" name="abc">'.$alphabet_bg[$i].'</a>&nbsp;&nbsp;';
                    $keys = $i;
                    break;
                }
            }
    ...
    <div class="wrap_alfrecet">
        <a href="/фирми/сортирай/0/{{$sorting}}" class="fa fa-list-ol btn btn-primary my_btn" name="abc" > Всички</a>
    </div>
</div>