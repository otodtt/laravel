...
/////
if (isset($workshop->date_petition)) {
    if ($workshop->date_petition == 0) {
        $date_petition = '';
    } else {
        $date_petition = date('d.m.Y', $workshop->date_petition);
    }
} else {
    $date_petition = null;
}
...
///////////////////////
if (isset($workshop->number_petition) && ($workshop->number_petition !== 0)) {
    $number_petition = $workshop->number_petition;
} else {
    $number_petition = '';
}
///////////////////////
