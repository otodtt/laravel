...
//}
///////
if (isset($pharmacy->date_petition)) {
    if ($pharmacy->date_petition == 0) {
        $date_petition = '';
    } else {
        $date_petition = date('d.m.Y', $pharmacy->date_petition);
    }
} else {
    $date_petition = null;
}
            ...
            <div class="col-md-9">
                <fieldset class="small_field">
                    ...
                    <div class="col-md-6 my_float">
                        ...
                        {!! Form::text('certificate', null, ['class'=>'form-control form-control-my ', 'size'=>1, 'maxlength'=>5 ]) !!}
                        {!! Form::text('date_certificate', null, ['class'=>'form-control form-control-my',
                                'id'=>'date_certificate', 'size'=>12, 'maxlength'=>10, 'placeholder'=>'дд.мм.гггг' ]) !!}
                    </div>
                </fieldset>
            </div>
            <div class="col-md-3 ">
