...
if (isset($repository->date_change)) {
    if ($repository->date_change == 0) {
        $date_petition = '';
    } else {
        $date_petition = '';
    }
...
if (isset($repository->number_change) && ($repository->number_change !== 0)) {
    $number_petition = '';
} else {
    $number_petition = '';
}
    ...
    <div class="row">
        <div class="col-md-5">
            <fieldset class="small_field">
                ...
                @else
                    <span class="bold">{!! $raz_ud !!} № {{$repository->number_licence}}
                        / {{date('d.m.Y',$repository->date_licence)}} г.</span>
                @endif
            </fieldset>
        </div>
