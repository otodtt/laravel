...
if (isset($pharmacy->date_change)) {
    if ($pharmacy->date_change == 0) {
        $date_petition = '';
    } else {
        $date_petition = '';
    }
...
if (isset($pharmacy->number_change) && ($pharmacy->number_change !== 0)) {
    $number_petition = '';
} else {
    $number_petition = '';
}
    ...
    <div class="row">
        <div class="col-md-5">
            <fieldset class="small_field">
                ...
                @else
                    <span class="bold">{!! $raz_ud !!} № {{$pharmacy->number_licence}}
                        / {{date('d.m.Y',$pharmacy->date_licence)}} г.</span>
                @endif
            </fieldset>
        </div>
