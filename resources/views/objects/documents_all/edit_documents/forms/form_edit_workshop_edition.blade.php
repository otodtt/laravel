...
$date_petition = date('d.m.Y', $workshop->date_change);
$date_edition = date('d.m.Y', $workshop->date_edition);
...
$number_petition = $workshop->number_change;
        ...
        <div class="row">
            <div class="col-md-5">
                <fieldset class="small_field">
                    ...
                    {!! Form::select('user_change', $inspectors, $workshop->id_user_change, ['id' =>'id_user',
