<div class="number_doc_all col-md-12 div_margin">
    ...
    <div class="col-md-12 row_bottom">
        <p id="p_edition">Издание: <span class="bold">№ {!! $edition !!} / {!! date('d.m.Y', $object->date_edition) !!}
...
<div class="col-md-12 div_margin">
    <p id="petition">Въз основа на Заявление с вх. №
        {!! $object->index_petition !!} - {!! $object->number_change !!} / {!! date('d.m.Y', $object->date_change) !!} г.
...
<div class="col-md-12 center uppercase div_margin">
    @if($object->active == 0)
        <h4 class="publish"><span class="bold">П Р Е И З Д А В А М:</span></h4>
    @else
        <h4 class="publish"><span class="bold red">П Р Е К Р А Т Я В А М:</span></h4>
    @endif
</div>
...
<div class="col-md-12 uppercase div_margin">
    <p ><span class="bold">УДОСТОВЕРЕНИЕТО Е ВАЛИДНО ДО: {{ date('d.m.Y', $object->end_date)}}
            <span class="lowercase">г.</span></span></p>
</div>
<div class="col-md-12 uppercase div_margin">
    <p >НАСТОЯЩОТО ИЗДАНИЕ Е НЕРАЗДЕЛНА ЧАСТ ОТ УДОСТОВЕРЕНИЕ № <span class="bold">{!! $number_licence !!}</span>
        ОТ <span class="bold">{!! date('d.m.Y', $object->date_licence) !!}</span> <span class="lowercase">г.</span>
    </p>
</div>
<div class="col-md-12 uppercase div_margin">
...
<div class="col-md-12 uppercase" id="bottom">
    <div class="col-md-12">
        <p class="bold inspector">ИЗГОТВИЛ: {{$object->user_change}}:..............................</p>
    </div>
    <div class="col-md-12">
        <div class="col-md-12">
