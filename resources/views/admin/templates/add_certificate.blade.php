    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10 panel panel-default" style="text-align: center; margin-top: 10px; vertical-align: middle">
                <span class="bold">ДОБАВЯНЕ НА ШАБЛОН ЗА СЕРТИФИКАТ</span>
            </div>
                ...
                <div class="panel panel-default">
                    <div class="alert alert-success alert-dismissible">
                        <p class="description_alert">
                            <i class="fa fa-warning red"></i> <span class="red">ВНИМАНИЕ!</span> В името на файла трябва да се съдържа "_certificate_body.blade"!<br/>
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        {!! Form::open(['url'=>'admin/templates-certificate-create' , 'method'=>'POST', 'id'=>'form', 'files'=>true]) !!}
                        <div class="form-group">
                            <label class="col-md-5 control-label">0000000000_certificate_body.blade </label>&nbsp;&nbsp;
                            <div class="col-md-6">
