    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10 panel panel-default" style="text-align: center; margin-top: 10px; vertical-align: middle">
                <span class="bold">ДОБАВЯНЕ НА ШАБЛОН ЗА ЛОГО НА ДОКУМЕНТИ</span>
            </div>
            <div class="col-md-10 ">
                <div class="panel panel-default">
                    <div class="alert alert-success alert-dismissible">
                        <p class="description_alert">
                            <i class="fa fa-warning red"></i> <span class="red">ВНИМАНИЕ!</span> В името на файла трябва да се съдържа "_logo.blade"!<br/>
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        {!! Form::open(['url'=>'admin/templates-logo-create' , 'method'=>'POST', 'id'=>'form', 'files'=>true]) !!}
                        <div class="form-group">
                            <label class="col-md-5 control-label">0000000000_logo.blade </label>&nbsp;&nbsp;
                            <div class="col-md-6">
