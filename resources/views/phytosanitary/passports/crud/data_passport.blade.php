        ...
        <div class="col-md-4">
            <fieldset class="small_field"><legend class="small_legend">Изписва се само града</legend>
                <div class="col-md-12 col-md-6_my" >
                    ...
                    {!! Form::text('city', null, ['class'=>'form-control form-control-my', 'size'=>50, 'maxlength'=>150, 'placeholder'=>'гр. Хасково/с. Малево' ]) !!}
                </div>
            </fieldset>
        </div>
        <div class="col-md-5">
            <fieldset class="small_field"><legend class="small_legend">Изписва се адреса ако се знае</legend>
                <div class="col-md-12 col-md-6_my" >
                    ...
                    {!! Form::text('address', null, ['class'=>'form-control form-control-my', 'size'=>60, 'maxlength'=>200, 'placeholder'=>'бул. "Освобождение" № 57 ' ]) !!}
                </div>
            </fieldset>
        </div>
        <div class="col-md-3">
