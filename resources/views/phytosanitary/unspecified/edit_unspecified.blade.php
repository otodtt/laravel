...
@section('content')
    ...
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <h3 class="my_center" style="color: #d9534f;">Редакция на данни на оператор Търговец!</h3>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="alert alert-info my_alert" role="alert">
            <div class="row">
                <div class="col-md-12 ">
                    <h4 class="my_center bold">РЕДАКЦИЯ НА ОПЕРАТОР</h4>
                    <p >Име на Фирма: <span class="bold">{!! $operator->name_operator !!}</span>;  ЕИК: <span class="bold">{!! $operator->pin !!}</span>

                    <p >С адрес: <span class="bold">{!! $operator->city!!}</span>, <span class="bold">{!! $operator->address_operator !!}</span></p>
                </div>
            </div>
        </div>
        {!! Form::model($operator, ['url'=>'фито/unspecified/store/'.$operator->id, 'method'=>'POST', 'autocomplete'=>'on']) !!}
