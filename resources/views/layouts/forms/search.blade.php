...
<div class="col-md-12 col-md-6_my " >
    ...
    <div class="col-md-4 col-md-6_my "  style="float: right" >
        <p class="description" >ЗАДЪЛЖИТЕЛНО попълнете коректно данните!<br/>
            1. Ако има съвпадение, уверете се, че това е търсения ЗС и натисни "ДОБАВИ СТАНОВИЩЕ ЗА ТОЗИ ЗС!".<br/>
            2. Ако няма намерен резултат, но ЕГН-то в вярно натисни "ДОБАВИ СТАНОВИЩЕ"
        </p>
    </div>
