...
?>
<span class="bold">ПРОВЕРЕН ОБЕКТ:</span>&nbsp;&nbsp;
<label class="ot"><span>АПТЕКА: </span>
    {!! Form::radio('ot', 1, false) !!}
</label>&nbsp;&nbsp;|
<label class="ot"><span>&nbsp;&nbsp;СКЛАД: </span>
    {!! Form::radio('ot', 2, false) !!}
</label>&nbsp;&nbsp;|
<label class="ot"><span>&nbsp;&nbsp;ЦЕХ: </span>
    {!! Form::radio('ot', 3, false) !!}
</label>
