            ...
            <fieldset class="small_field"><legend class="small_legend">Констатация и други данни</legend>
                        ...
                        <fieldset class="mini_field mini_top">
                            ...
                            <div class="col-md-6 col-md-6_my  " >
                                <label class="violation"><span>НЕ: </span>
                                    {!! Form::radio('violation', 0, $return_no, array('class'=>'violation')) !!}
                                </label>&nbsp;&nbsp;|
                                <label class="violation "><span>&nbsp;&nbsp;ДА: </span>
                                    {!! Form::radio('violation', 1, $return_yes, array('class'=>'violation')) !!}
                                </label>
                            </div>
                        </fieldset>
                        <fieldset class="mini_field">
                            ...
                            <div class="col-md-6 col-md-6_my" >
                                <label class="act"><span>НЕ: </span>
                                    {!! Form::radio('act', 0, $act_no) !!}
                                </label>&nbsp;&nbsp;|
                                <label class="act"><span>&nbsp;&nbsp;ДА: </span>
                                    {!! Form::radio('act', 1, $act_yes) !!}
                                </label>
                            </div>
                        </fieldset>
                    </div>
                ...
                <div class="col-md-12 col-md-6_my  ">
                    <div class="col-md-4 col-md-6_my inspectors_divs ">
                        ...
                        {!! Form::textarea('ascertainment', $return_ascertainment, ['class'=>'form-control form-control-my', 'cols'=>'50', 'rows'=>'4']) !!}
                    </div>
                    <div class="col-md-4 col-md-6_my inspectors_divs ">
                        {!! Form::label('taken', 'Конфискувани:', ['class'=>'my_labels']) !!}
                        {!! Form::textarea('taken', $return_taken, ['class'=>'form-control form-control-my', 'cols'=>'50', 'rows'=>'4']) !!}
                    </div>
                    <div class="col-md-4 col-md-6_my inspectors_divs ">
                        {!! Form::label('order_protocol', 'Предписание:', ['class'=>'my_labels']) !!}
                        {!! Form::textarea('order_protocol', $return_order_protocol, ['class'=>'form-control form-control-my', 'cols'=>'50', 'rows'=>'4']) !!}
                    </div>
                </div>
            </fieldset>
        </div>
