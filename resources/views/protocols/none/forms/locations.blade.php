<p class="description" ><span class="bold red"><i class="fa fa-warning"></i> Внимание</span>
    Ако не се знае къде е регистрирана Фирмата/Лицето изберете оласта, общината и насленото място
    където е проверявания обект. В адреса или в констатациите напишете, че не се знае регистрацията!
</p>
...
?>
{!! Form::text('list_name', $name_select, ['class'=>'form-control form-control-my', 'list'=>'places', 'id'=>'list_name', 'size'=>25, 'autocomplete'=>'off' ]) !!}
...
{!! Form::text('address', null, ['class'=>'form-control form-control-my', 'size'=>32, 'maxlength'=>250 ]) !!}