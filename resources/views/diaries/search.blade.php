...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold red layout-title">ТЪРСИ ЗЕМЕДЕЛСКИ СТОПАНИН И ДОБАВИ ЗАВЕРКА НА ДНЕВНИК</h4>
    </div>
    <hr/>
    <div class="btn-group">
        ...
        <a href="{!! URL::to('/дневници')!!}" class="fa fa-book btn btn-primary my_btn"> Всички Заверени Дневнициа</a>
    </div>
    <hr/>
    ...
    <div class="container-fluid" >
        <div class="row">
            <div class="col-md-12" >
                ...
                {!! Form::open(['url'=>'/търси-дневник' , 'method'=>'POST', 'id'=>'form']) !!}
    ...
    <div class="div_find">
        ...
        @if(isset($farmers))
            @if(count($farmers) == 0)
                ...
                <div class="col-md-6 col-md-6_my " >
                    {!! Form::open(['url'=>'/нов/дневник' , 'method'=>'GET', 'id'=>'form_new_opinion']) !!}
                        <input type="submit" class="fa fa-address-card-o btn btn-success my_btn_check" value=" ДОБАВИ ЗЕМЕДЕЛСКИ СТОПАНИН И ЗАВЕРКА НА ДНЕВНИК">
                        @if($firm == 1)
            ...
            @else
                @foreach($farmers as $farmer)
                    <div class="col-md-12 col-md-6_my " >
                        ...
                        <div class="col-md-6 col-md-6_my " >
                            <a href="{!! URL::to('/стопанин/'.$farmer->id)!!}" class="fa fa-user btn btn-success my_btn_check" > КЪМ ДАННИТЕ НА ЗС!</a>
                        </div>
                    </div>
                @endforeach
            @endif
...
@section('scripts')
    {!!Html::script("js/diaries/search/searchFarmer.js" )!!}
    {!!Html::script("js/diaries/search/searchFarmerByPin.js" )!!}
    {!!Html::script("js/diaries/search/searchFarmerByName.js" )!!}
    {!!Html::script("js/diaries/search/searchFirmByName.js" )!!}
@endsection