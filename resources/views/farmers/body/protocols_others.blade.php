<fieldset class="apt_all_field">
    ...
    @if(!empty($old_protocols))
        <fieldset class="old_opinions">
            <legend class="legend_apt">СТАРИ КОНСТАТИВНИ ПРОТОКОЛИ - издадени за Държавни плащания</legend>
            <?php $n=1; ?>
            <table>
                <tbody>
    ...
    @if(!empty($protocols->toArray()))
        <fieldset class="new_opinions">
            <legend class="legend_apt">КОНСТАТИВНИ ПРОТОКОЛИ - издадени за Държавни плащания</legend>
            <?php $n=1; ?>
            <table>
                <tbody>
