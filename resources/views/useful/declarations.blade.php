...
@section('content')
    ...
    <div class="btn-group" >
        ...
        <span class="fa fa-pencil-square-o btn btn-default my_btn"> Декларации</span>
    ...
    <hr/>
    <h3 style="text-align: center; margin: 20px 0">ДЕКЛАРЦИИ</h3>
    <hr/>
    {{-- ВСИЧКИ --}}
    @if(count($regulations) !== 0)
        <div class="row" style="margin-top:20px">
            <div class="col-lg-12">
                <h3 style="text-align: left">Декларации касаещи всички отдели</h3>
                <table>
                    <tbody>
                    <?php $n = 1; ?>
                    @foreach($regulations as $regulation)
                        <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.45); border-top: 1px solid rgba(0, 0, 0, 0.45);">
    ...
    @if(count($controls) !== 0)
        ...
        <div class="row" style="margin-top:20px">
            <div class="col-lg-12">
                <h3>Декларации касаещи контрола</h3>
                <table>
                    <tbody>
                    <?php $n = 1; ?>
                    @foreach($controls as $regulation)
                        <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.45); border-top: 1px solid rgba(0, 0, 0, 0.45);">
                            <td style="padding: 10px"><?= $n++ ?></td>
                            <td>{{$regulation->document_name}}</td>
                            <td>
    ...
    @if(count($fsc) !== 0)
        ...
        <div class="row" style="margin-top:20px">
            <div class="col-lg-12">
                <h3>Декларации касаещи ФСК</h3>
                <table>
                    <tbody>
                    <?php $n = 1; ?>
                    @foreach($fsc as $regulation)
                        <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.45); border-top: 1px solid rgba(0, 0, 0, 0.45);">
                            <td style="padding: 10px"><?= $n++ ?></td>
                            <td>{{$regulation->document_name}}</td>
                            <td>
    ...
    @if(count($quality) !== 0)
        ...
        <div class="row" style="margin-top:20px">
            <div class="col-lg-12">
                <h3>Декларации касаещи КППЗ</h3>
                <table>
                    <tbody>
                    <?php $n = 1; ?>
                    @foreach($quality as $regulation)
                        <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.45); border-top: 1px solid rgba(0, 0, 0, 0.45);">
                            <td style="padding: 10px"><?= $n++ ?></td>
                            <td>{{$regulation->document_name}}</td>
                            <td>
