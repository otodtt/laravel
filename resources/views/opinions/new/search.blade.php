...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold red layout-title">ТЪРСИ ЗЕМЕДЕЛСКИ СТОПАНИН И ДОБАВИ НОВО СТАНОВИЩЕ</h4>
    </div>
    <hr/>
    <div class="btn-group">
    ...
    <div class="container-fluid" >
        <div class="row">
            <div class="col-md-12" >
                ...
                {!! Form::open(['url'=>'/търси-становище' , 'method'=>'POST', 'id'=>'form']) !!}
                    @include('layouts.forms.search')
            ...
            @if(count($farmers) == 0)
                <div class="col-md-6 col-md-6_my " >
                    <p class="new_farmer bold">
                        ...
                        Добави Становище на НОВ Земеделски Производител
                    </p>
                </div>
                <div class="col-md-6 col-md-6_my " >
                    {!! Form::open(['url'=>'/ново/становище' , 'method'=>'GET', 'id'=>'form_new_opinion']) !!}
                        <input type="submit" class="fa fa-address-card-o btn btn-success my_btn_check" value=" ДОБАВИ СТАНОВИЩЕ">
                        @if($firm == 1)
            ...
            @else
                @foreach($farmers as $farmer)
                    <div class="col-md-12 col-md-6_my " >
                        ...
                        <div class="col-md-6 col-md-6_my " >
                            <a href="{!! URL::to('/добави/становище/'.$farmer->id)!!}" class="fa fa-address-card-o btn btn-success my_btn_check" > ДОБАВИ СТАНОВИЩЕ ЗА ТОЗИ ЗС!</a>
                        </div>
                    </div>
                @endforeach
            @endif
...
@section('scripts')
    {!!Html::script("js/farmers/searchFarmer.js" )!!}
    {!!Html::script("js/farmers/searchFarmerByPin.js" )!!}
    {!!Html::script("js/farmers/searchFarmerByName.js" )!!}
    {!!Html::script("js/farmers/searchFirmByName.js" )!!}
@endsection