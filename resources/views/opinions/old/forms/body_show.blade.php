...
<fieldset><legend>ДАННИ ЗА СТАНОВИЩЕТО</legend>
    ...
    @else
        ...
        <span><a class="fa fa-eye btn btn-primary my_btn" href="{!!URL::to('/стари-протокол-зс/'.$opinion->number_protocol.'/'.$opinion->date_protocol)!!}" style="margin: 3px 0"> ВИЖ Протокола</a></span>
    @endif
    <hr/>
