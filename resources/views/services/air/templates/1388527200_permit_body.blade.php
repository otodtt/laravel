...
<div class="col-md-12 uppercase div_margin">
    ...
    <div class="col-md-3 " >
        <p>{{ $egn_eik  }}: <strong>{{ $permit->urn }}</strong></p>
    </div>
    ...
    <div class="col-md-12" style="margin-top: 10px">
        <p >СЪС СЕДАЛИЩЕ И АДРЕС НА УПРАВЛЕНИЕ В: <span class="bold">{{ $tvm }} {{ $permit->location }}</span>, </p>
    </div>
    <div class="col-md-12 " style="margin-top: 10px">
...
<div class="col-md-12  div_margin" style="text-indent: 1.5em; text-align: justify">
    <p class="bold">■ Площта, която ще се третира е на територията на ОДБХ  {!! $logo[0]['city'] !!}</p>
    <p class="bold">■  Разрешението е валидно за периода от {{ date('d.m.Y', $permit->start_date) }} до {{ date('d.m.Y', $permit->end_date) }} г. </p>
    <p class="bold">■ Срок за уведомяване на собствениците на пчелни семейства, разположени в землището на
        кметството по местонахождение на площите, които ще бъдат третирани, както и собствениците на пчелни семейства,
        разположени в граничещите землища, за датата и часа, в който ще се извършва всяко прилагане на продукти за
        растителна защита чрез въздушно пръскане: {{ date('d.m.Y', $permit->start_date -172800) }} г.</p>
</div>
<div class="col-md-12  div_margin" style="text-indent: 1.5em; text-align: justify; font-style: italic">
    <p class="bold" >Информацията е публикувана на интернет страницата на ОДБХ {!! $logo[0]['city'] !!} и включва местонахождението на площите, които ще бъдат третирани, датата и часа, когато ще се извършва въздушното пръскане и вида на продукта за растителна защита, който ще бъде прилаган.</p>
</div>
