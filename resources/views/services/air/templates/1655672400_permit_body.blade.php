...
@else
    ...
    <div class="col-md-12_my uppercase" id="bottom" style="text-align: center; " >
        ...
        @if($logo[0]['fax'] == 0)
            <p style="font-size: 0.9em; font-weight: bold; text-transform: lowercase"><i class="fa fa-phone"></i> +359(0){!! $logo[0]['phone'] !!}; www.bfsa.egov.bg</p>
        @else
            <p style="font-size: 0.9em; font-weight: bold; text-transform: lowercase"><i class="fa fa-phone my_fa"></i> / <i class="fa fa-fax"></i> : +359(012){!! $logo[0]['fax'] !!},
