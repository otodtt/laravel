...
class PhitoOperator extends Model
{
    ...
    protected $fillable = [
        ...
        'derivation', 'purpose', 'room', 'action', 'deletion', 'deletion_date', 'operator_index_not', 'operator_index_bg', 'address',
        'registration_number', 'registration_date', 'registration_order', 'date_order', 'is_completed', 'is_lock'
    ];
}
