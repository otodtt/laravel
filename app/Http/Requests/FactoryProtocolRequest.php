...
class FactoryProtocolRequest extends Request
{
    /**
    ...
    public function rules()
    {
        ...
        $data = [
            ...
            'prz_av' => 'min:2|max:100|required_if:assay_prz,1',
            'assay_more' => 'required_if:assay_prz,1',
    ...
    public function messages()
    {
        $data = [
            ...
            'prz_name.required_if' => 'Маркирано е, че има взета проба. Напиши името на Тора!',
            'prz_name.min' => 'Минимален брой символи за полето "Име на ПРЗ:" - 2!',
            'prz_name.max' => 'Максимален брой символи за полето "Име на ПРЗ:" - 100!',

            'prz_av.min' => 'Минимален брой символи за полето "Активно Вещество:" - 2!',
            'prz_av.max' => 'Максимален брой символи за полето "Активно Вещество:" - 100!',
            'prz_av.required_if' => 'Попълни Активното вещество на ПРЗ!',
