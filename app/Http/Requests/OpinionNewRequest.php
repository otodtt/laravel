...
class OpinionNewRequest extends Request
{
    /**
    ...
    {
        return [
            'type_firm.required' => 'Маркирай вида на фирмата или ЧЗС!',
            ...
            'number_protocol.not_in' => 'Номера на Констативния Протокол не може да е нула!',
