...
class DirectorsUpdateRequest extends Request
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'start_date' => 'required|date_format:d.m.Y|min_date_update'
        ];
    ...
    public function messages()
    {
        return [
            ...
            'start_date.min_date_update'=>'Не може датата да е преди датата на назначаване на предишния Директор!'
        ];
    }
}
