...
class CertificatesCreateRequest extends Request
{
    /**
    ...
    public function rules()
    {
        ...
        $data = [
            'number' => 'required|numeric|unique:certificates,number|min:1',
    ...
    {
        return [
            'number.required' => 'Номера на Сертификата е задължителен! Не променяй ако не е необходимо!',
            'number.numeric' => 'Номера на Сертификата е само с цифри! Не променяй ако не е необходимо!',
            'number.unique' => 'Номера на Сертификата трябва да е уникален! Намерен е Сертификат с този номер!',
            'number.min' => 'Номера на Сертификата не може да е нула - 0!',
            ...
            'gender.required' => 'Маркирай  дали е мъж или жена! Ако не се знае ЕГН-то, маркирай - "Без ЕГН" ',
            ...
            'file.required'=>'Задължително избери снимка!',
